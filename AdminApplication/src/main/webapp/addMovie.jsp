...
<div class="container-lg">
    <div class="navbar">
      <h2 style="color:white">Add new Movies</h2>
    </div>
  <form class="form-horizontal" method="post" action="addmovie" enctype="multipart/form-data">
    <div class="form-group">
      <label class="control-label col-sm-4" for="name">Movie Name:</label>
        <div class="col-sm-4">
          <input type="text" class="form-control" id="name" placeholder="Enter movie name" name="name">
        </div>
    </div>
<!--    <div class="form-group">
